        ...
        <div className="p-5 flex flex-col flex-grow">
          <div className="flex justify-between items-center mb-3">
            <motion.h3
              ...
              transition={modalTransition}
              className="text-lg font-heading font-bold text-gray-900 dark:text-white transition-colors group-hover:text-indigo-500 dark:group-hover:text-indigo-400"
            >
              {project.title}
            </motion.h3>
...
const Project = () => {
  ...
  return (
    <section className="min-h-screen w-full mt-20 py-10 bg-transparent text-foreground relative" id="projects">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <h2 className="text-3xl font-heading font-bold mb-4 dark:text-white relative inline-block">
            Featured Projects
            <span className="absolute bottom-0 left-1/3 w-1/3 h-1 bg-neutral-700 dark:bg-neutral-500 rounded-full" />
          </h2>
          <p className="text-base text-gray-600 dark:text-gray-400 leading-relaxed max-w-2xl mx-auto font-sans">
            Explore the complete directory of my technical projects, featuring client websites, job portals, AI-powered applications, and digital toolsets.
          </p>
        </motion.div>
