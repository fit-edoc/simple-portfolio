...
<div className="flex py-2.5 gap-1 items-center"> <GithubIcon  size={30} className="hover:bg-white hover:text-black  rounded-full px-1.5 py-1.5"/> <X  size={30} className="hover:bg-white hover:text-black  px-1.5 py-1.5 dark:rounded-full"/><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="currentColor" className="icon icon-tabler icons-tabler-filled icon-tabler-brand-linkedin  fill-blue-400 hover:bg-white rounded-full px-1.5 py-1.5"><path stroke="" d="M0 0h24v24H0z" fill="none"/><path d="M17 2a5 5 0 0 1 5 5v10a5 5 0 0 1 -5 5h-10a5 5 0 0 1 -5 -5v-10a5 5 0 0 1 5 -5zm-9 8a1 1 0 0 0 -1 1v5a1 1 0 0 0 2 0v-5a1 1 0 0 0 -1 -1m6 0a3 3 0 0 0 -1.168 .236l-.125 .057a1 1 0 0 0 -1.707 .707v5a1 1 0 0 0 2 0v-3a1 1 0 0 1 2 0v3a1 1 0 0 0 2 0v-3a3 3 0 0 0 -3 -3m-6 -3a1 1 0 0 0 -.993 .883l-.007 .127a1 1 0 0 0 1.993 .117l.007 -.127a1 1 0 0 0 -1 -1" /></svg></div>
<div className="flex gap-1.5 mt-1.5"> <button  className="px-4 py-1 text-white rounded-full border border-white bg-[#000000]"><Resume/></button><button className="px-4 py-1 text-white rounded-full border border-white bg-black flex items-center gap-1.5 justify-center">Connect with <Talk/></button></div>
