...
export function Navbar() {
    return (
       <div className="w-full h-[90px]  py-2.5 px-10 flex justify-center">
         <nav className="mx-auto  fixed w-[300px] h-[60px]  px-5.5 rounded-xl py-4 border-b   border-gray-800 flex  gap-5 items-center  shadow-[0px_0px_1px_white] bg-[#ffffff58] backdrop-blur-[10px] dark:border-gray-100 dark:bg-[#0007] dark:text-white text-black md:w-[350px] md:justify-center">
